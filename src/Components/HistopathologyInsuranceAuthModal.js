...
export default function HistopathologyInsuranceAuthModal({ isOpen, onClose, setOldPayload, activateNotifications, type, oldPayload }) {
    ...
    const getAllDetails = async () => {
        ...
        setData(oldPayload.testRequired);
