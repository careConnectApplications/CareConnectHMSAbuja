        ...
        <div style="text-align: center; margin-bottom: 30px; border-bottom: 2px solid #2B6CB0; padding-bottom: 20px;">
          ...
          <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 15px;">
            <div style="text-align: left; flex: 1;">
              <p style="margin: 2px 0; color: #333; font-size: 12px;"><strong>Patient:</strong> ${patientName}</p>
              <p style="margin: 2px 0; color: #333; font-size: 12px;"><strong>MRN:</strong> ${patientMRN}</p>
              <p style="margin: 2px 0; color: #333; font-size: 12px;"><strong>Age:</strong> ${patientAge} years</p>
            </div>
            <div style="text-align: right; flex: 1;">
              <p style="margin: 2px 0; color: #333; font-size: 12px;"><strong>Gender:</strong> ${patientGender}</p>
              <p style="margin: 2px 0; color: #333; font-size: 12px;"><strong>Phone:</strong> ${patientPhone}</p>
              <p style="margin: 2px 0; color: #333; font-size: 12px;"><strong>Generated:</strong> ${moment().format("MMMM DD, YYYY")}</p>
            </div>
          </div>
        </div>
      `;
