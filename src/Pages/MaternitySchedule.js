...
export default function MaternitySchedule() {
  ...
  const ExaminePatient = (item) => {
    ...
    nav(`/dashboard/maternity-timeline/${item.patient?._id}`);
  ...
  return (
    <MainLayout>
      ...
      <Seo title="Maternity Schedule" description="Care connect Manage Maternity Schedule" />
      ...
      <Text color={subTitleTextColor} mt="9px" fontWeight="400" fontSize="15px">
        View and manage all maternity appointments in one place. Quickly access statuses,
        update details, and manage maternity schedules as needed.
      </Text>
