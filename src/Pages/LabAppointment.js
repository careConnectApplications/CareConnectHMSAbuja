...
export default function LabAppointment() {
    ...
    const filterBy = (title) => {
        ...
        if (title === "appointmentId") {
            ...
            let filter = Data.filter(item => item.testname?.toLowerCase().includes(SearchInput.toLowerCase()))
            setFilteredData(filter)

        } else if (title === "testId") {
            let filter = Data.filter(item => item.testid?.toLowerCase().includes(SearchInput.toLowerCase()) || item.lastName?.toLowerCase().includes(SearchInput.toLowerCase()))
            setFilteredData(filter)
    ...
    return (
        ...
        >
        {
                    ...
                    <HStack>
                        ...
                        <Menu isLazy>
                            ...
                            <MenuList >
                                ...
                                <MenuItem onClick={() => filterBy("testName")} textTransform="capitalize" fontWeight={"500"} color='#2F2F2F' _hover={{ color: "#fff", fontWeight: "400", bg: "blue.blue500" }}>
                                    <HStack fontSize="14px">

                                        <Text>by Test Name</Text>
                                    </HStack>
                                </MenuItem>
                                <MenuItem onClick={() => filterBy("testId")} textTransform="capitalize" fontWeight={"500"} color='#2F2F2F' _hover={{ color: "#fff", fontWeight: "400", bg: "blue.blue500" }}>
                                    <HStack fontSize="14px">
            ...
            >
                ...
                <Text mb="20px" fontWeight="700" fontSize="16px" color="blue.blue500">Lab History</Text>
                <TableContainer>
                ...
                <LabRequestModal isOpen={OpenLabModal} oldPayload={{ _id: id, appointmentid: id }} onClose={() => setOpenLabModal(false)}  activateNotifications={activateNotifications} />
