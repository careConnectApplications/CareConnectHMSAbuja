...
export default function Histopathology() {
  const {
    bgColor,
    textColor,
    borderColor,
  ...
  const filterScheduled = () => {
    ...
    setProcessed(false);
    getAllScheduledPathology("scheduled")
    setStatus("scheduled")
    setCurrentPage(1)
  };
  ...
  const filterAwaitingConfirmation = () => {
    ...
    getAllScheduledPathology("awaiting confirmation")
    ...
    <MainLayout>
      ...
      >
        <Flex justifyContent="space-between" flexWrap="wrap">
          ...
          >
            <Box borderRight={`1px solid ${borderColor}`} pr="5px" onClick={filterScheduled}>
              <Text
                py="8.5px"
                px="12px"
