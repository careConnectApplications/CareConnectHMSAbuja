...
export default function SingleHistopathologyReport() {
    ...
    const ViewHistopathologyResult = (id) => {
        nav(`/dashboard/histopathology-process/report/${id}`)
        localStorage.setItem("pathname", pathname)
    }

    useEffect(() => {
        getAllHistopathologyReport()
    }, [isOpen, Trigger]);
        ...
        >
         {
            ...
            >
                ...
                <Text mb="20px" fontWeight="700" fontSize="16px" color="blue.blue500">Histopathology Report History</Text>
