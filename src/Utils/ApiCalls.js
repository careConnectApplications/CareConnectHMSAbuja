...
export const CreateMortalityRegisterApi = (payload) => {
  const data = JSON.stringify(payload);
  const config = {
    method: "post",
    maxBodyLength: Infinity,
    url: `${baseUrl}/maternity/mortality-register/create`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
...
export const GetMortalityRegisterByPatientApi = (patientId) => {
  const config = {
    method: "get",
    url: `${baseUrl}/maternity/mortality-register/patient/${patientId}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
...
export const AddEyePreliminaryTestApi = (payload) => {
  ...
  let config = {
    method: "post",
    maxBodyLength: Infinity,
    url: `${baseUrl}/eye-module/preliminary-test`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
...
export const AddEyeExaminationApi = (payload) => {
  let data = JSON.stringify(payload);
  let config = {
    method: "post",
    maxBodyLength: Infinity,
    url: `${baseUrl}/eye-module/create-examination`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
...
export const CreateHistologyApi = (payload) => {
  let data = JSON.stringify(payload);
  let config = {
    method: "post",
    maxBodyLength: Infinity,
    url: `${baseUrl}/histopathology`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
...
export const GetAllHistopathologyApi = (postPerPage, pageNo, status) => {
  ...
  let config = {
    method: "get",
    url: `${baseUrl}/histopathology?status=${status}&page=${pageNo}&limit=${postPerPage}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
...
export const GetPreviousEyeRecordsApi = (id) => {
  // Configure the GET request
  let config = {
    method: "get",
    url: `${baseUrl}/eye-module/patient/${id}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
...
export const UploadRadiologyResultApi = (file, radiologyOrderId) => {
  ...
  return axios
    ...
    .catch((error) => {
      ...
      console.error("Error uploading radiology result:", errormsg);
      throw new Error(errormsg);
    });
};
...
export const ViewMultipleRadiologyResultsApi = async (fileNames) => {
  try {
    ...
    console.error("Error viewing multiple radiology results:", errormsg);
    throw new Error(errormsg);
  }
};
...
export const UploadProcedureResultApi = (file, procedureId) => {
  ...
  return axios
    ...
    .catch((error) => {
      ...
      console.error("Error uploading procedure result:", errormsg);
      throw new Error(errormsg);
    });
};
...
export const SortByHematologyAndChemicalPathologyApi = (id, labcategory) => {
  if (!token) {
    console.error("No authentication token found");
    throw new Error("Authentication token is missing");
  }
  if (!id) {
    console.error("No labRequestId provided");
    throw new Error("Lab Request ID is required");
  }

  const data = JSON.stringify({ labcategory });
  console.log("API Payload:", { id, labcategory, data });

  const config = {
    method: "put",
    url: `${baseUrl}/lab/sortbyhemathologyandchemicalpathology/${id}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
  ...
  return axios
    .request(config)
    .then((response) => {
      console.log(`Sorted to ${labcategory}:`, response.data);
      return response.data;
    })
    .catch((error) => {
...
export const ReadAllScheduledLabOptimizedHematologyAndChemicalPathologyApi = (
  labCategory
) => {
  const config = {
    method: "get",
    url: `${baseUrl}/lab/readallscheduledlaboptimizedhemathologyandchemicalpathology?labcategory=${labCategory}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
  ...
  return axios
    .request(config)
    .then((response) => {
      console.log("Scheduled lab data retrieved:", response.data);
      return response.data;
    })
    .catch((error) => {
      console.log("error", error.response);
...
export const ProcessPeripheralBloodFilmReportApi = (id, payload) => {
  const config = {
    method: "put",
    url: `${baseUrl}/lab/labresultprocessinghemathologychemicalpathology/${id}?labreporttypehematologychemicalpathology=peripheralbloodfilmreport`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
  ...
  return axios
    ...
    .then((response) => {
      console.log(
        "Peripheral blood film report processed:",
        JSON.stringify(response.data)
      );
      return response;
    })
...
export const ProcessADHBoneMarrowAspirationReportApi = (id, payload) => {
  const config = {
    method: "put",
    url: `${baseUrl}/lab/labresultprocessinghemathologychemicalpathology/${id}?labreporttypehematologychemicalpathology=ADHbonemarrowaspirationreport`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
  ...
  return axios
    ...
    .then((response) => {
      console.log(
        "ADH bone marrow aspiration report processed:",
        JSON.stringify(response.data)
      );
      return response;
    })
...
export const ProcessChemicalPathologyReportApi = (id, payload) => {
  const config = {
    method: "put",
    url: `${baseUrl}/lab/labresultprocessinghemathologychemicalpathology/${id}?labreporttypehematologychemicalpathology=chemicalpathologyreport`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
  ...
  return axios
    ...
    .then((response) => {
      console.log(
        "Chemical pathology report processed:",
        JSON.stringify(response.data)
      );
      return response;
    })
...
export const CreateDentalEncounterApi = (id, payload) => {
  const data = JSON.stringify(payload);

  const config = {
    method: "post",
    maxBodyLength: Infinity,
    url: `${baseUrl}/dental/createdentalencounter/${id}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
  ...
  return axios
    .request(config)
    .then((response) => {
      console.log("Dental encounter created:", JSON.stringify(response.data));
      return response;
    })
    .catch((error) => {
      console.log("error", error.response);
...
export const GetDentalEncountersByPatientIdApi = (id) => {
  const config = {
    method: "get",
    url: `${baseUrl}/dental/readalldentalbypatient/${id}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
  ...
  return axios
    .request(config)
    .then((response) => {
      console.log("Dental encounters retrieved:", response.data);
      return response.data;
    })
    .catch((error) => {
      console.log("error", error.response);
...
export const UpdateDentalEncounterApi = (id, payload) => {
  const data = JSON.stringify(payload);

  const config = {
    method: "put",
    maxBodyLength: Infinity,
    url: `${baseUrl}/dental/updatedentalencounter/${id}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
  ...
  return axios
    .request(config)
    .then((response) => {
      console.log("Dental encounter updated:", JSON.stringify(response.data));
      return response;
    })
    .catch((error) => {
      console.log("error", error.response);
...
export const CreatePhysiotherapyAssessmentApi = (id, apiPayload) => {
  console.log("CreatePhysiotherapyAssessmentApi", id, apiPayload);
  let data = JSON.stringify(apiPayload);

  let config = {
    method: "post",
    maxBodyLength: Infinity,
    url: `${baseUrl}/physiotherapy/createphysiotherapyassessments/${id}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
...
export const UpdatePhysiotherapyAssessmentApi = (id, apiPayload) => {
  console.log("UpdatePhysiotherapyAssessmentApi", id, apiPayload);
  let data = JSON.stringify(apiPayload);

  let config = {
    method: "put",
    maxBodyLength: Infinity,
    url: `${baseUrl}/physiotherapy/updatephysiotherapyassessment/${id}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
...
export const GetAllPhysiotherapyAssessmentByPatientApi = (id) => {
  console.log("GetAllPhysiotherapyAssessmentByPatientApi", id);
  let config = {
    method: "get",
    url: `${baseUrl}/physiotherapy/readallphysiotherapyassessmentbypatient/${id}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
...
export const GetCashierTotalApi = () => {
  const config = {
    method: "get",
    url: `${baseUrl}/billing/getcashiertotal`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
...
export const CreateFirstStageLabourApi = (payload) => {
  ...
  const config = {
    method: "post",
    maxBodyLength: Infinity,
    url: `${baseUrl}/maternity/first-stage-labour/create`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
...
export const UpdateFirstStageLabourApi = (payload, id) => {
  const data = JSON.stringify(payload);
  const config = {
    method: "put",
    maxBodyLength: Infinity,
    url: `${baseUrl}/maternity/first-stage-labour/update/${id}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
...
export const ReadOneDentalEncounterApi = (dentalEncounterId) => {
  const config = {
    method: "get",
    maxBodyLength: Infinity,
    url: `${baseUrl}/dental/readonedentalencounter/${dentalEncounterId}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
...
export const UpdateAdmissionStatusApiDoc = (admissionId, updateData) => {
  ...
  return axios
    .request(config)
    .then((response) => {
      return response.data; // Returns success msg + updatedAdmission
    })
    .catch((error) => {
  ...
  return axios
    ...
    .catch((error) => {
      ...
      if (error.response) {
        ...
        // Handle other errors
        errormsg = error.msg || "Unknown error occurred";
      }
...
export const countPatientsPerDoctorApi = (clinicName) => {
  ...
  return axios(config)
    ...
    .catch((error) => {
      ...
      throw new Error(error.msg || "Failed to fetch patient counts");
    });
};
...
export const GetAllUnitApi = (clinic) => {
  const config = {
    method: "get",
    maxBodyLength: Infinity,
    url: `${baseUrl}/settings/getunitsbyclinicname/${clinic}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
...
export const GetUnitsByClinicNameApi = (clinicName) => {
  const config = {
    method: "get",
    url: `${baseUrl}/settings/getunitsbyclinicname/${clinicName}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
...
export const CreateBirthRegisterApi = (payload) => {
  const data = JSON.stringify(payload);
  const config = {
    method: "post",
    maxBodyLength: Infinity,
    url: `${baseUrl}/maternity/birth-register/create`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
  ...
  return axios
    .request(config)
    .then((response) => {
      console.log("Birth Register created:", JSON.stringify(response.data));
      return response.data;
    })
    .catch((error) => {
      console.log("error", error.response);
...
export const GetBirthRegisterByPatientApi = (patientId) => {
  const config = {
    method: "get",
    url: `${baseUrl}/maternity/birth-register/patient/${patientId}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
  ...
  return axios
    .request(config)
    .then((response) => {
      console.log("Birth Register data retrieved:", response.data);
      return response.data;
    })
    .catch((error) => {
      console.log("error", error.response);
...
export const UpdateBirthRegisterApi = (payload, id) => {
  const data = JSON.stringify(payload);
  const config = {
    method: "put",
    maxBodyLength: Infinity,
    url: `${baseUrl}/maternity/birth-register/update/${id}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
  ...
  return axios
    .request(config)
    .then((response) => {
      console.log("Birth Register updated:", JSON.stringify(response.data));
      return response.data;
    })
    .catch((error) => {
      console.log("error", error.response);
...
export const GetBirthRegisterByIdApi = (id) => {
  const config = {
    method: "get",
    url: `${baseUrl}/maternity/birth-register/get/${id}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
...
// Postnatal Care API Calls
export const CreatePostnatalCareApi = (payload) => {
  const data = JSON.stringify(payload);
  const config = {
    method: "post",
    maxBodyLength: Infinity,
    url: `${baseUrl}/maternity/postnatal-care/create`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
...
export const GetPostnatalCareByPatientApi = (patientId) => {
  const config = {
    method: "get",
    url: `${baseUrl}/maternity/postnatal-care/patient/${patientId}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
  ...
  return axios
    .request(config)
    .then((response) => {
      console.log("Postnatal Care data retrieved:", response.data);
      return response.data;
    })
    .catch((error) => {
      console.log("error", error.response);
...
export const UpdatePostnatalCareApi = (payload, id) => {
  const data = JSON.stringify(payload);
  const config = {
    method: "put",
    maxBodyLength: Infinity,
    url: `${baseUrl}/maternity/postnatal-care/update/${id}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
...
export const GetPostnatalCareByIdApi = (id) => {
  const config = {
    method: "get",
    url: `${baseUrl}/maternity/postnatal-care/get/${id}`,
    headers: {
      "Content-Type": "application/json",
      Authorization: `Bearer ${token}`,
    },
